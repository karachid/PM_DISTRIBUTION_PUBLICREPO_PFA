  ...
  <head>
    ...
    function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
                                                              ['Site', 'nbreFactsLibres'],
                                                              <c:forEach items="${factsLibresParSite}" var="entry">
                                                                  [ '${entry.key}', ${entry.value} ],
                                                              </c:forEach>
                                                        ]);
        // Set chart options
        var options = {
        			'title' : 'Nombre de facteurs libres par site',
                    is3D : true,
    ...
    function drawSecChart() {
        ...
        // Create the data table.    
        var data = google.visualization.arrayToDataTable([
                                                              ['Site', 'nbreSectsParSite'],
                                                              <c:forEach items="${nbreSectsParSite}" var="entry">
                                                                  [ '${entry.key}', ${entry.value} ],
                                                              </c:forEach>
                                                        ]);
        // Set chart options
        var options = {
        			'title' : 'Nombre de secteurs par site',
                    is3D : true,
                    backgroundColor: '#E4E4E4',
                    pieSliceText: 'label',
                    tooltip :  {showColorCode: true},
