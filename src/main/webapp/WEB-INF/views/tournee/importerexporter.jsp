          ...
          <section class="wrapper site-min-height">
          	...
          	<div class="row mt">
          		...
          		<p>Place your content here.</p>
							<div class="col-lg-6">
									<h2>Importer une liste de tournées</h2>
									<p>Cliquez sur le button pour charger une liste des tournées depuis un fichier Excel</p>
									<br>
							...
							<div class="col-lg-6">
									<h2>Exportation de la liste des tournées</h2>
									<p align="justify"> En cliquant sur le button "Exporter la liste des tournées", vous allez générer un fichier Excel où chaque ligne représente une tournée avec ses détails.  </p>
									<a href="<%=request.getContextPath() %>/tournee/exportlisttour/" class="btn btn-warning btn-lg"> 
										<span class="glyphicon glyphicon-export"></span>  Exporter la liste des tournées
									</a>
							</div>		
							</div>
					</div>
